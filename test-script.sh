...
INFRA_PATH="frontend-infrastructure"
...
# Initialize Terraform with backend and state configuration
...
CLOUDFRONT_DOMAIN=$(cd .. && terraform output -raw cloudfront_domain || echo "")
